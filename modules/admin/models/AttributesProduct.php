...
class AttributesProduct extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(ProductAndAttributes::className(), ['attribut_value' => 'attr_value']);
    }
    ...
    {
        return $this->hasMany(Products::className(), ['id' => 'id_product'])->viaTable('product_and_attributes', ['attribut_value' => 'attr_value']);
    }
}
